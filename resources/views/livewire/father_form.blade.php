    ...
    <div style="display: none" class="row setup-content" id="step-1">
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-row">
                    <div class="col">
                        <label for="title">{{trans('login_trans.Email')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('login_trans.Password')}}</label>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col">
                        ...
                        <select class="custom-select my-1 mr-sm-2" wire:model="father_type_blood">
                            <option selected>{{trans('parent_trans.Choose')}}...</option>
                            @foreach($type_bloods as $type_blood)
                                <option value="{{$type_blood->id}}">{{$type_blood->name}}</option>
                            @endforeach
                        </select>
                        @error('father_type_blood')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group col">
